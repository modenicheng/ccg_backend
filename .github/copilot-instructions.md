...
- `tests/ws_conn.py` is the helper file to create a real ws connection with the server. Find the usage and examples in `tests/test_playback_message_ws.py`
...
- Deserialize with `.model_validate(obj)`
